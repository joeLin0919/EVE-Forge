...
public class ChartUtil {
    ...
    public static byte[] generatePriceTrendChart(List<HistoricalOrderObj> data, String itemName) {
        ...
        // 设置图例字体
        chart.getLegend().setItemFont(new Font("SimHei", Font.PLAIN, 12));
        ...
        // 设置轴标签字体
        plot.getDomainAxis().setLabelFont(new Font("SimHei", Font.PLAIN, 12));
        plot.getRangeAxis(0).setLabelFont(new Font("SimHei", Font.PLAIN, 12)); // 价格Y轴
